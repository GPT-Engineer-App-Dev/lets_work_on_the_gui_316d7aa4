...
import { FaDownload, FaFileUpload, FaPrint, FaCog, FaPaperPlane, FaMicrophone, FaRegKeyboard } from "react-icons/fa";
        ...
        <Flex w="full" wrap="wrap" gap={10}>
          ...
          <Box w={{ base: "full", md: "65%" }} p={5} borderWidth="1px" borderRadius="lg">
            <VStack spacing={4}>
              ...
              <Textarea placeholder="Enter your message here..." bg="white" borderColor="blue.500" />

              <Button leftIcon={<FaPaperPlane />} colorScheme="blue" variant="solid">
                Send Message
              </Button>
            </VStack>
          </Box>
          ...
          <VStack w={{ base: "full", md: "35%" }} spacing={5}>
            <Box w="full" h="250px" borderWidth="1px" borderRadius="md" overflow="hidden">
              <Image src="https://images.unsplash.com/photo-1642334640124-c80d5e7e78d3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1MDcxMzJ8MHwxfHNlYXJjaHwxfHxhbmltYXRlZCUyMGF2YXRhcnxlbnwwfHx8fDE3MDUzMjQ3MzJ8MA&ixlib=rb-4.0.3&q=80&w=1080" borderRadius="full" />
            </Box>
            <Button leftIcon={<FaFileUpload />} _hover={{ bg: "blue.500", color: "white" }}>
              Upload New Avatar
            </Button>
            <HStack>
